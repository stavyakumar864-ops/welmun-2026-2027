...
const CommitteeDetail = () => {
  ...
  return (
    <>
      {/* Montage layer — fixed background (lowest layer) */}
      <CommitteeIntro
        committeeId={committee.id}
        committeeName={committee.shortName}
      />

      {/* Committee info — scrolls over the montage, then peels away to reveal montage again */}
      <div className="relative z-[2]" style={{ clipPath: "inset(0)" }}>
        {/* Spacer so montage is visible first */}
        <div className="h-screen" />

        {/* Actual committee content */}
